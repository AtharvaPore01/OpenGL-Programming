...
GLfloat radius, x, y, a, b, c, Perimeter, Semi_Perimeter, Area_Of_Triangle, x_center, y_center, h;
//OGLRectangleInCircle Variables
GLfloat Number_Of_Sides = 4.0f, radius_Of_Circle, Top, Bottom, Left, Right, Area_of_Rectangle;
...
void OGLDisplay(void)
{
	...
	//Function declaration
	void OGLCircleInsideTriangle(void);
	void OGLRectangleInCircle(void);
	...
	OGLCircleInsideTriangle();
	OGLRectangleInCircle();
...
*/
	...
	fprintf_s(gpFile, "Area_Of_Triangle = %f\n\n", Area_Of_Triangle);	
	...
	fprintf_s(gpFile, "x_center = %f\n", x_center);
	fprintf_s(gpFile, "y_center = %f\n\n", y_center);
