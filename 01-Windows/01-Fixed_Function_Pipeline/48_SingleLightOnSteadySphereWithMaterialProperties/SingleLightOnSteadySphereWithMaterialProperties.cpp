...
GLfloat LightPosition[] = { 100.0f, 100.0f, 100.0f, 1.0f };			//{ 1.0f, 1.0f, 1.0f, 1.0f };
...
void OGLDisplay(void)
{
	...
	glRotatef(Rotation_Angle_Sphere, 1.0f, 1.0f, 1.0f);
...
{
	//code
	Rotation_Angle_Sphere = Rotation_Angle_Sphere + 1.0f;
	if (Rotation_Angle_Sphere >= 360.0f)
	{
		Rotation_Angle_Sphere = 0.0f;
	}
}
