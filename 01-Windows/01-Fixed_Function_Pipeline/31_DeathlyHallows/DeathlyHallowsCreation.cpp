...
//Generalised
GLfloat radius, x, y, a, b, c, Perimeter, Area_Of_Triangle, x_center, y_center, h, Rotation_Angle, Rotation_Angle_triangle, Rotation_Angle_circle;
//For Calculation Of Sides
GLfloat x1, x2, x3, y01, y2, y3, Return_Perimeter, Return_Area, Return_Radius; 
//Initialisation
...
void OGLDisplay(void)
{
	...
	{
		y_triangle = y_triangle + 0.0005;
		x_triangle = x_triangle - 0.0005;
		if(y_triangle > 0.0f)
		{
			bCircle = true;
		}		
