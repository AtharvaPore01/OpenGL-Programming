...
GLfloat LightPositio_zero[] = { -2.0f, 0.0f, 0.0f, 1.0f };
...
GLfloat LightPositio_one[] = { 2.0f, 0.0f, 0.0f, 1.0f };
...
int OGLInitialise(void)
{
	...
	glLightfv(GL_LIGHT0, GL_POSITION, LightPositio_zero);
	glEnable(GL_LIGHT0);
	...
	glLightfv(GL_LIGHT1, GL_POSITION, LightPositio_one);
	glEnable(GL_LIGHT1);
