...
GLfloat radius, x, y, a, b, c, Perimeter, Area_Of_Triangle, x_center, y_center, h, Rotation_Angle;
GLfloat Indentity_Matrix[16], Translation_Matrix[16], Rotation_Matrix[16], SIN_VALUE, COS_VALUE;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szAppName,
		TEXT("Reactangle On Graph paper"),
...
int OGLInitialise(void)
{
	...
	//FirstColumn
	Indentity_Matrix[0] = 1.0f;
	Indentity_Matrix[1] = 0.0f;
	Indentity_Matrix[2] = 0.0f;
	Indentity_Matrix[3] = 0.0f;
	//SecondColumn
	Indentity_Matrix[4] = 0.0f;
	Indentity_Matrix[5] = 1.0f;
	Indentity_Matrix[6] = 0.0f;
	Indentity_Matrix[7] = 0.0f;
	//ThreeColumn
	Indentity_Matrix[8] = 0.0f;
	Indentity_Matrix[9] = 0.0f;
	Indentity_Matrix[10] = 1.0f;
	Indentity_Matrix[11] = 0.0f;
	//FourthColumn
	Indentity_Matrix[12] = 0.0f;
	Indentity_Matrix[13] = 0.0f;
	Indentity_Matrix[14] = 0.0f;
	Indentity_Matrix[15] = 1.0f;
...
void OGLDisplay(void)
{
	...
	//glLoadIdentity();
	glLoadMatrixf(Indentity_Matrix);
	glMultMatrixf(Translation_Matrix);

	//FirstColumn
	Rotation_Matrix[0] = cosf(Rotation_Angle);
	Rotation_Matrix[1] = 0.0f;
	Rotation_Matrix[2] = -sinf(Rotation_Angle);
	...
	//ThreeColumn
	Rotation_Matrix[8] = sinf(Rotation_Angle);
	Rotation_Matrix[9] = 0.0f;
	Rotation_Matrix[10] = cosf(Rotation_Angle);
