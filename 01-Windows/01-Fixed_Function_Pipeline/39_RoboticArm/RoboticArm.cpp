...
int Elbow = 0;
int Palm = 0;
GLUquadric *quadric_elbow;
GLUquadric *quadric_shoulder;
GLUquadric *quadric_palm;
...
void RoboticArm(void)
{
	...
	quadric_shoulder = gluNewQuadric();
	gluSphere(quadric_shoulder, 0.5f, 10, 10);
	glPopMatrix();//2
	...
	quadric_palm = gluNewQuadric();
	gluSphere(quadric_palm, 0.5, 10, 10);
...
void OGLUninitialise(void)
{
	...
	if(quadric_shoulder)
	{
		gluDeleteQuadric(quadric_shoulder);
		quadric_shoulder = NULL;
	}
	if(gpFile)
	{
