...
{
	//code
	Lights[0].Angle = Lights[0].Angle + 0.5f;
	if (Lights[0].Angle >= 360)
	{
		Lights[0].Angle = 0.0f;
	}

	Lights[1].Angle = Lights[1].Angle + 0.5f;
	if (Lights[1].Angle >= 360)
	{
		Lights[1].Angle = 0.0f;
	}

	Lights[2].Angle = Lights[2].Angle + 0.5f;
	if (Lights[2].Angle >= 360)
	{
		Lights[2].Angle = 0.0f;
	}
