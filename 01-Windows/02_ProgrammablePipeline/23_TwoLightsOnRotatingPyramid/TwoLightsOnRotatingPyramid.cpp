...
void oglDisplay(void)
{
	...
	if (bLight)
	{
		...
		glUniform3fv(La_uniform_red, 1, Lights[0].Ambient);
		glUniform3fv(Ld_uniform_red, 1, Lights[0].Diffuse);
		glUniform3fv(Ls_uniform_red, 1, Lights[0].Specular);
		//send blue light intensity
		glUniform3fv(La_uniform_blue, 1, Lights[1].Ambient);
		glUniform3fv(Ld_uniform_blue, 1, Lights[1].Diffuse);
		glUniform3fv(Ls_uniform_blue, 1, Lights[1].Specular);
		...
		//send light position
		glUniform4fv(lightPosition_uniform_red, 1, Lights[0].Position);
		glUniform4fv(lightPosition_uniform_blue, 1, Lights[1].Position);
	}
	else
	{
