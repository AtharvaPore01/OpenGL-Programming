...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void oglInitialise()
	{
		...
		*/
		...
		//specify above source code to shader object
		GLES32.glShaderSource(	geometryShaderObject,
		...
		*/
		...
		if(iShaderCompileStatus[0] != 0)
		{
			...
			if(iInfoLogLength[0] > 0)
			{
				...
				System.out.println("RTR : Geometry Shader Compilation error : "+szInfoLog);
				oglUninitialise();
				System.exit(0);
			}
		}
		...
		*/
		...
		ByteBuffer byteBuffer_position = ByteBuffer.allocateDirect(triangleVertices.length * 4);	//java doesn't have sizeof() so, size of an array = array length * size of type 
		...
		//step 1: allocate the buffer directly from native memory(unmanaged memory)
		ByteBuffer byteBuffer_color = ByteBuffer.allocateDirect(triangleColor.length * 4);	//java doesn't have sizeof() so, size of an array = array length * size of type 
