package com.Atharva_Pore.diffuse_light_sphere;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener
{
	...
	private void oglDisplay()
	{
		...
		if(bLight == true)
		{
			...
			GLES32.glUniform3f(Ld_Uniform, 0.5f, 0.2f, 0.7f);
			//send coefficient of material difuse reflectance
			GLES32.glUniform3f(Kd_Uniform, 0.7f, 0.7f, 0.7f);
			//send light position
			GLES32.glUniform4f(lightPosition_Uniform, 100.0f, 100.0f, 100.0f, 1.0f);
		}
		else
		{
