...
GLUquadric *quadric_earth 	=	NULL;
GLUquadric *quadric_moon 	=	NULL;
...
void SolarSystem(void)
{
	...
	quadric_sun		=	gluNewQuadric();
	glColor3f(1.0f, 1.0f, 0.0f);
	gluSphere(quadric_sun, 0.75f, 30, 30);
	glPopMatrix();
	...
	gluSphere(quadric_earth, 0.3f, 20, 20);
	...
	gluSphere(quadric_moon, 0.15f, 30, 30);
	glPopMatrix();
